...
7. Learn about the ["Document Object Model"](https://dom.spec.whatwg.org/) (DOM) and the many ways you can interact with it with JS. Don't prematurely optimize stuff, but if you plan on doing a lot of fancy UI manipulation with JS, it's useful to learn about [performance optimization techniques](https://developer.mozilla.org/en-US/docs/Web/Performance) (especially for startup, repaints, reflows, and event delegation when just starting out). Learning about how frameworks often handle some of this for you can be a good place to start learning as well.
