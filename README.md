...
Keep in mind: decoupling the FE and BE this way can increase the complexity of the entire system, even if each system can better separate concerns, result in improved UX and reduce overall network traffic in many situations.  When we were forced to build these things at the dawn of the "Web 2.0" era, we really didn't understand what we were doing so well, and things got awful real fast for a real long time 💩. This "checklist" is basically my attempt to provide others what I would have liked to have had back then. Things are a bit better these days, but make sure your project requirements actually call for this before traveling down this road... remember, it's dangerous to go alone!
