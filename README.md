...
4. DS web components or framework components can reference (or “copy paste”, script an export process, etc) HTML from the pattern library for implementation.  Components are dynamic implementations of patterns that allow for encapsulation and reuse of UI code within the application. Not all patterns need be, or should be, implemented as web components (and sometimes vice versa). Automated and manual component integration tests happen here. It's best to only include reusable components with no external or remote dependencies in your DS; integrated app testing should happen separately.
