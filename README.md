...
*Also wik: There are many other considerations you will need to make while working on your application, such as security, live ops, UX design, change management, etc. These are also important, but not relevant to this general-use design. This doc just describes the basic things that most all decoupled, evergreen FE web apps of reasonable complexity must consider for an accessible and high quality experience.*
