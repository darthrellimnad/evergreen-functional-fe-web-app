...
4. Design system patterns and/or components can be tested with simple html files, or a tool like storybook. Global community can participate in unit & integration testing if these tests are made publicly accessible. Spread the work.
